...
{
    let i = 0;
    createHTML(idL, "span", settingsCanvas.w+"|"+settingsCanvas.h);
    for (let iCell of palette.tiles.values()) 
    {
        ...
        // import
        createHTML(idL, "span", iCell.world.x+"|"+iCell.world.y+"_"+iCell.local.x+"|"+iCell.local.y+
    ...
    document.getElementById("totalCells").innerHTML = i;
} 
